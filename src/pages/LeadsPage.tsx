...
export const LeadsPage = () => {
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-8">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm shadow-md md:relative md:bg-transparent md:shadow-none">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-24 md:pt-8">
        {/* Search and Filters */}
